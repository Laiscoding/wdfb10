...
const minnum = document.querySelector('.minnumber'),
	...
	getbtn.addEventListener('click',function(e){
		...
		if(guess === winningnum){
			...
			//message1
			// message1.textContent = `Gameover, You Lost, The correct number is ${winningnum} `;
			// message1.style.color = "red";

			// setmessage1(`Gameover, You Lost, The correct number is ${winningnum}`,color);
			...
			gameover(false,`Gameover, You Lost, The correct number is ${winningnum}`);
				...
				// setmessage1(`${guess} is not correct!, ${gameleft} guess left`,color);
